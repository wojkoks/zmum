...
\begin{figure}[H]
    ...
    \caption{Przykładowa wizualizacja jakości wybranego modelu boostingowego (XGBoost) w scenariuszu z uszkodzonymi danymi.}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Tabela porównawcza metod selekcji cech (Cz.3) wraz z liczbą wybranych cech.}
